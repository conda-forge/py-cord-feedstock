...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py-cord-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14157&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-cord-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py-cord` can be installed with:

```
conda install py-cord
```

It is possible to list all of the versions of `py-cord` available on your platform with:
